        ...
        televisores.map(
          televisor =>
            ...
            >
              ...
              <span> - {televisor.pulgadas}" </span>

              <span> - {televisor.sistema_operativo}</span>
            </li>
        )
      }
    </ul>
    ...
    <ul className="list-group mb-5">
      {
        televisores.map(
          televisor =>
            televisor.sistema_operativo === "Google TV" && (
              <li
                key={televisor.id}
                className="list-group-item"
              >
